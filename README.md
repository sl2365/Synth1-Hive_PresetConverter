...
### NOTE:
For the conversion to work correctly, you MUST update all Synth1 presets to Ver=113! You can use the AutoHotKey script for this, but it can only do so automatically one bank at a time.
